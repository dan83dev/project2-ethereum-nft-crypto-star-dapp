...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            ...
            "You must own one of the Stars to be able to exchange"
        );
        ...
        _transferFrom(ownerTokenOne, ownerTokenTwo, _tokenId1);
        _transferFrom(ownerTokenTwo, ownerTokenOne, _tokenId2);
    }
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender,
            "You must own the Star to be able to transfer"
        );
